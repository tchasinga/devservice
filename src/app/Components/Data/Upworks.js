...
const  projectmanager = [
    {
      ...
      },
      {
        ...
        title: "Single-pages",
        image: Singlepages,
        details: "building server-rendered applications. While its often used for server-side rendering, it can also be used to create single-page applications (SPAs) with client-side rendering. Here&apos;s a brief overview of how to create a single-page application using Next.js",
